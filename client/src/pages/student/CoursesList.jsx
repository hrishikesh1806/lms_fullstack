...
    }, [allCourses, input])
    
    // Search Bar Styling: White background, black text, and blue focus ring.
    const searchBarClassName = "md:mt-2 mt-4 bg-white text-black border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 flex-1 md:max-w-md placeholder-gray-500 transition-all duration-200";

    return (
        /* MODIFIED: Darkened the bottom gradient color from #0000CD to #00004d for deeper contrast. */
        <div 
